...
public class UI {
            ...
            Entity monster = gp.monster[gp.currentMap][i];
                ...
                if(monster != null && monster.inCamera() == true){
                    ...
                    if(monster.hpBarOn == true && monster.boss == false){
                        ...
                        g2.fillRect(monster.getScreenX() - 1, monster.getScreenY() - 11, gp.tileSize + 2, 9);
                
                        g2.setColor(new Color(255,0,30));
                        g2.fillRect(monster.getScreenX(), monster.getScreenY()- 10, (int)hpBarValue, 7);
    ...
    public void drawTitleScreen(){
        ...
        String text = "THE LAND OF FANTASY";
